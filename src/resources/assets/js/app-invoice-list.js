...
$(function () {
  ...
  if (dt_invoice_table.length) {
    var dt_invoice = dt_invoice_table.DataTable({
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            var $row_output =
              ...
              '<a href="' +
              baseUrl +
              'pages/profile-user" class="text-truncate"><h6 class="mb-0">' +
              $name +
              '</h6></a>' +
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              '<a href="' +
              baseUrl +
              'app/invoice/preview" data-bs-toggle="tooltip" class="text-body" data-bs-placement="top" title="Preview Invoice"><i class="mdi mdi-eye-outline mdi-20px mx-1"></i></a>' +
              '<div class="dropdown">' +
      ...
      dom:
        '<"row me-1 my-2"' +
        '<"col-12 col-md-6 d-flex align-items-center justify-content-center justify-content-md-start"f>' +
        '<"col-12 col-md-6 d-flex align-items-center justify-content-center justify-content-md-end gap-3 mb-3 mb-md-0"<"invoice_status"><"dt-action-buttons text-xl-end text-lg-start text-md-end text-start"B>>' +
        '>t' +
        '<"row mx-1"' +
